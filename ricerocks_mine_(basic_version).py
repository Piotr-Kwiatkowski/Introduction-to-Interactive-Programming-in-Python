# adres http://www.codeskulptor.org/#user39_AFyKCBIJ6N_8.py
...
soundtrack = simplegui.load_sound("https://www.dropbox.com/s/o07gei7objg3cur/space_wind.mp3?dl=1")
#missile_sound = simplegui.load_sound("http://commondatastorage.googleapis.com/codeskulptor-assets/sounddogs/missile.mp3")
missile_sound = simplegui.load_sound("https://www.dropbox.com/s/3nvlgvjqsw6m7fq/andromada_pulse-rifle.wav?dl=1")
...
def group_collide(group, other_object):
    original_group = len(group)
    for item in set(group):
        if item.collide(other_object):
            group.remove(item)
            
    if original_group != len(group):
        return True
    else:
        return False
